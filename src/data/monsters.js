...
export const MONSTERS = {
  ...
  // The one thing in this region that can both catch you and hurt you.
  //
  // Depths 4 and 5 killed 2.3% and 1.2% of the crusaders who reached them,
  // against 17.6% and 23.0% one region below, off a threat budget that climbs
  // smoothly across the join. What the Reliquary lacked was not numbers but an
  // archetype: speed and power sat on different monsters here, so the fast one
  // was harmless and this one, at speed 80, was slower than a crusader and
  // could be walked away from. The Choir's winged thing carries speed 150 and
  // power 8 at once, and a player met that combination cold on depth 7.
  //
  // Raising the moth's power instead was tried first and did almost nothing --
  // 2.3% to 3.4% on depth 4 -- because 7 hit points die to one swing from a
  // crusader who has just killed the Herald. Power on a creature that never
  // gets to use it is not a threat. 18 hit points and defense 3 are what make
  // this one live long enough for speed 110 to mean something.
  ossuaryWarden: {
    name: 'ossuary warden', glyph: 'w', color: 'monsterTough',
    weight: 6, maxHp: 18, power: 6, defense: 3, speed: 110, xp: 24,
  },
  boneSlinger: {
