...
export const REGIONS = [
  {
    ...
    depths: [1, 3],
    monsters: ['campDog', 'deserter', 'flagellant'],
    boss: 'herald',
  ...
  },
  {
    ...
    depths: [4, 6],
    monsters: ['bonepicker', 'reliquaryMoth', 'ossuaryWarden'],
    boss: 'saintAmbrose',
  ...
  },
  {
    ...
    depths: [7, 9],
    monsters: ['chorister', 'censerbearer', 'wingedThing'],
    boss: 'theVoice',
  ...
  },
  {
    ...
    depths: [10, 12],
    monsters: ['aDoubt', 'pilgrimHusk', 'sepulchreWorm'],
    boss: 'whatYouCameFor',
    final: true,
